const NodemonIcon = () => (
    <svg version="1.1" id="template" xmlns="https://www.w3.org/2000/svg"
         x="0px" y="0px" width="40" height="40" viewBox="0 0 160 185"
         style={{borderRadius: "4px", backgroundColor: "#77d04b",
    display: "block",
    fill: "#4f4d3f"}}
    >
        <path d="M158.156,60.461l-5.326-3.066
                ...
                C162.535,64.914,160.879,62.018,158.156,60.461z"></path>
    </svg>
);
